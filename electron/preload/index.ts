...
const api: IpcApi = {
  ...
  markChatRead: (jid) => ipcRenderer.invoke(IPC_CHANNELS.chatMarkRead, jid),
  setActiveChat: (jid) => ipcRenderer.invoke(IPC_CHANNELS.chatSetActive, jid),
  triggerResync: () => ipcRenderer.invoke(IPC_CHANNELS.syncTrigger),
